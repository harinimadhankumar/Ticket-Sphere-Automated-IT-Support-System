...
import { isLoggedIn, getEngineerData, getInitials } from '../../utils/auth';
    ...
    return (
        <Layout showNav={true} showUser={true} showSidebar={true} showSecondaryNav={true} >
            ...
            <div className="settings-tabs">
                ...
                {/* Profile Tab - Using Profile.jsx UI */}
                {activeTab === 'profile' && (
                        ...
                        <div className="profile-card-body">
                            ...
                            <div className="profile-form-section">
                                ...
                                <div className="notifications-grid">
                                    {/* Left Column - Notification Labels */}
                                    <div className="notifications-list">
                                        <div className="notification-item">Email notifications for ticket updates</div>
                                        <div className="notification-item">SLA alerts</div>
                                        <div className="notification-item">Daily summary emails</div>
                                    </div>
                                    ...
                                    <div className="notifications-checkboxes">
                                        <div className="checkbox-wrapper">
                                            <input
                                                ...
                                                checked={preferences.emailTicketUpdates}
                                                onChange={(e) => setPreferences({...preferences, emailTicketUpdates: e.target.checked})}
                                            />
                                        </div>
                                        <div className="checkbox-wrapper">
                                            <input
                                                ...
                                                onChange={(e) => setPreferences({...preferences, slaAlerts: e.target.checked})}
                                            />
                                        </div>
                                        <div className="checkbox-wrapper">
                                            <input
